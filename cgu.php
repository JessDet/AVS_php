...
<div class="container_cgu">
    ...
    <div class="titlecgu">
            <h1>CONDITIONS</h1>
            <h2>GENERALES D'UTILISATION</h2>
    </div>

    <p class="article_cgu">ARTICLE 1 : Objet

Les présentes « conditions générales d'utilisation » ont pour objet l'encadrement juridique de l’utilisation du site MGM et de ses services.
...
Le site MGM est édité par Pierre Dupont, domicilié au 10 rue de la République 62400 Béthune.
</p>

<p class="article_cgu">
ARTICLE 3 : accès aux services

L’Utilisateur du site MGM a accès aux services suivants :
•	Visualisation des road-trip, bar, restaurant
•	Ajout de bar, restaurant, road-trip
•	Mur de partage
...
L’Utilisateur assume l’entière responsabilité de l’utilisation qu’il fait des informations et contenus présents sur le site MGM.
...
Le site MGM s'engage à mettre en œuvre tous les moyens nécessaires pour garantir la ssécurité et la confidentialité des données. Toutefois, il n’apporte pas une garantie de sécurité totale.
...
Les contenus du site MGM (logos, textes, éléments graphiques, vidéos, etc.) sont protégées par le droit d’auteur, en vertu du Code de la propriété intellectuelle.
...
L’adresse électronique (e-mail) de l’utilisateur pourra notamment être utilisée par le site MGM pour la communication d’informations diverses et la gestion du compte.

MGM garantie le respect de la vie privée de l’utilisateur, conformément à la loi n°78-17 du 6 janvier 1978 relative à l'informatique, aux fichiers et aux libertés.

Le site est déclaré auprès de la CNIL sous le numéro suivant : 0
...
Les domaines vers lesquels mènent les liens hypertextes présents sur le site n’engagent pas la responsabilité de l’Éditeur de MGM, qui n’a pas de contrôle sur ces liens.

Il est possible pour un tiers de créer un lien vers une page du site MGM sans autorisation expresse de l’éditeur.
</p>
<p class="article_cgu">

ARTICLE 9 : Évolution des conditions générales d’utilisation

Le site MGM se réserve le droit de modifier les clauses de ces conditions générales d’utilisation à tout moment et sans justification.
</p>
<p class="article_cgu">
...
En cas de litige non résolu à l’amiable entre l’Utilisateur et l’Éditeur, les tribunaux de Béthune sont compétents pour régler le contentieux.
