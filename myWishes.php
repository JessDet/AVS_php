...
$stateRead = $pdo->prepare("SELECT idSouhait, titre,categorie,descriptif, dateAjout, user.pseudo, user.image 
    ...
    ON souhait.idUser = user.idUser WHERE user.idUser=:idUser and souhait.status=0");
...
<body>
    ...
    <main class="container">
        ...
        <div class="encours">
            <H1 class="title">MES SOUHAITS</H1>
        </div>
        ...
        <div id="categories">
            <ul class="category-container">
                ...
                <li class="fz">
                    <a class="cat" href="/myWishes.php" style="color:white;">Tous les Souhaits<span class="small">(<?= count($allWishes) ?>)</span></a>
                </li>
                <?php foreach ($cat ?? [] as $cKey => $cNum) : ?>
                    <li class="fz">
                        <a class="cat" style="color:white;" href="/myWishes.php?cat=<?= $cKey ?>"><?= $cKey ?><span class="small">(<?= $cNum ?>)</span></a>
                    </li>
                <?php endforeach; ?>
        ...
        <div class="login-popup">
            <div class="form-popup" id="popupForm">
                <form action="/myWishes.php" method="POST" class="form-container">
